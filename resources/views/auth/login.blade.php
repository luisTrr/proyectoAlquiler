...
@section('content')
    ...
    <main class="main-content  mt-0">
        <section>
            <div class="page-header min-vh-100" style="background-image: url('https://www.inu.cl/wp-content/uploads/2020/10/p-pexels-david-mcbee-1546168-1.jpg.jpeg');">
                <div class="container">
                    <div class="row">
                        <div class="col-md-6 offset-md-3">
                            <div class="card">
                                <div class="card-header pb-0 text-start">
                                    ...
                                    <p class="mb-0">Ingresa tu correo electronico y contraseña para iniciar sesión</p>
                                </div>
                                <div class="card-body">
                        ...
                        <!-- <div
                            ...
                            <div class="position-relative bg-gradient-primary h-100 m-3 px-7 border-radius-lg d-flex flex-column justify-content-center overflow-hidden"
                                style="background-image: url('https://img.freepik.com/vector-premium/logo-edificio-nombre-empresa-inmobiliaria_698417-34.jpg?w=996');
