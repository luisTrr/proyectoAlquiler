<aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 "
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'home' ? 'active' : '' }}" href="{{ route('home') }}">
                    ...
                    <span class="nav-link-text ms-1">Disponibles</span>
                </a>
            </li>
            <li class="nav-item mt-3 d-flex align-items-center">
                ...
                <h6 class="ms-2 text-uppercase text-xs font-weight-bolder opacity-6 mb-0">Publicaciones</h6>
            </li>
            <!-- <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link " href="{{ route('estadoPublicacion') }}">
                    <div
                        class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="fa fa-exclamation-triangle text-info text-sm opacity-10"></i>
                    </div>
                    <span class="nav-link-text ms-1">Estado Publicacion</span>
                </a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link " href="{{ route('asignarRol') }}">
                    <div
                        class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
    ...
    <div class="sidenav-footer mx-3 ">
        <div class="card card-plain shadow-none" id="sidenavCard">
            <img class="w-50 mx-auto" src="/img/illustrations/UAB.jpg"
        ...
        <a class="btn btn-primary btn-sm mb-0 w-100"
            href="https://www.facebook.com/SoyUAB" target="_blank" type="button">Facebook UAB</a>
    </div>
</aside>
